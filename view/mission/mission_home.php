...
<div  style=" background:#3C3C3C; " >
    ...
    <div  style="width:100%;font-size:20px;text-align:center; padding-top:10px;background:#FF2D2D;height:50px;color:#FFFFFF;" >任務</div>

         <div class="9u 22u(narrow)"style="margin:0px auto;padding-top:50px;">
                <div class="row" >
                  <?php connect("mission","list")?>                 

                  </div>
              </div>

                <!-- Footer -->
                    <section id="footer" style="height:200px; background:#3C3C3C; ">
                        <div class="container">
...
<div data-role="main" class="ui-content"  style=" background:#3C3C3C;height:900px; ">
        ...
        <div style="padding-top:50px;text-align:center;margin:0 auto;">
            <button type="button"   onclick="" style="width:110px;margin: 0px auto;color:#FFFFFF;background-color:#FF2D2D;border-color:#FF2D2D"><a href="#pagetwofb" style="font-size:14px;">Start</button>
        </div>
</div>
</div><!--pagetwo END-->

<div data-role="page" id="pagetwofb" style=" background:#3C3C3C;" >
...
<div class="fb-page" data-href="https://www.facebook.com/mcdonalds.tw/" data-width="100%" data-height="40%"
data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"></div>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
        ...
        <div style="padding-top:50px;text-align:center;margin:0 auto;">
            <a href="mission_home.php" onclick="Reflish()" ><button type="button"   onclick="missioninsert()" style="width:110px;margin: 100px ;color:#FFFFFF;background-color:#FF2D2D;border-color:#FF2D2D">完成</button></a>
        </div>
</div>
</div><!--pagetwo END-->
<!-- 任務完成-->
