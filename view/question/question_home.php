...
<html>
    <head>
        ...
        <script src="../../jquery-mobile-js/jquery-2.1.4.min.js"></script>s
...
<div data-role="page" id="pagequestion" >
      <div id="right-15" data-role="panel" data-position="right" data-theme="b">
          <header>
...
<div data-role="header" data-position="fixed" data-theme="a" style="background:#FF2D2D;">
    ...
    <a class="ui-btn ui-btn-right ui-btn-icon-left ui-icon-bars" style="padding:18px; background:none;" href="#right-15"></a>
...
<div  style=" background:#3C3C3C; " >
    ...
    <div  style="width:100%;font-size:20px;text-align:center; padding-top:10px;background:#FF2D2D;height:50px;color:#FFFFFF;" >問卷</div>

              <div class="9u 20u(narrow)"style="margin:0px auto;padding-top:50px;">
                <?php connect("question","list");?>
                </div>
              </div>
...
<div data-role="page" id="pagetwo" style=" background:#3C3C3C;" >
    ...
    <div id="right-menu16" data-role="panel" data-position="right" data-theme="b">
          <header>
...
<div data-role="header" data-position="fixed" data-theme="a" style="background:#FF2D2D;">
    <h3 style="color:#FFFFFF;">消費問卷</h3>
    <a class="ui-btn ui-icon-arrow-l ui-btn-icon-left " onclick="goBack()"  style="padding:18px; background:none;"></a>
    <a class="ui-btn ui-btn-right ui-btn-icon-left ui-icon-bars" style="padding:18px; background:none;" href="#right-menu16"></a>
</div>
...
<form method="post" id='insert_form'>
        ...
        <div id="abc"></div>
        <INPUT TYPE=hidden id="decide" NAME="decide" VALUE="insert">
<div style="padding-top:70px;">
            <button type="button"   onclick="viewdate.insert()" style="width:200px;margin: 0px auto;color:#FFFFFF;background-color:#00FF00;border-color:#00FF00">問卷填寫完成</button>
        </div>
